...
<body>
  ...
  if (isset($_GET['id'])) {
      ...
      if ($row = $result->fetch_assoc()) {
          ...
          echo "<div class='status'>Missing</div>";
          echo "<p><span>Age:</span> " . htmlspecialchars($row['age']) . "</p>";
          echo "<p><span>Gender:</span> " . htmlspecialchars($row['gender']) . "</p>";
		  echo "<p><span>Missing date:</span> " . htmlspecialchars($row['date_missing']) . "</p>";
          echo "<p><span>Last Seen:</span> " . htmlspecialchars($row['last_seen_location']) . "</p>";
          echo "<p><span>Description:</span> " . htmlspecialchars($row['description']) . "</p>";
          echo "<a href='index.php#missin-section' class='back-btn'>Back to All Records</a>";
          echo "</div></div>";
      } else {
